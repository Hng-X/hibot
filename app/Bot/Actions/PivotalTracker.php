...
class PivotalTracker extends Action
{
    ...
    public function run()
    {
        return $this->addToPivotal($this->data["email"]);
    }

    public function addToPivotal($email, $projId = "1961795")
    {
    ...
    {
        $this->sendPivotalAddResult($result, $this->request);
    }

    public function sendPivotalAddResult($result, array $data, $project = "Factory_core")
    {
        $team = $data['team_id'];
